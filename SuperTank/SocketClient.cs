...
namespace SuperTank
{
    public class SocketClient
    {
        ...
        {
            localPlayer = new SuperTank.Objects.PlayerTank { Name = playerName }; // Assuming PlayerTank has a Name property
        }
        // Kết nối đến server
        ...
        private static void UpdatePlayInfo(string[] payload)
        {
            ...
            foreach (string playerName in playerNames)
            {
                ...
                {
                    players.Add(new SuperTank.Objects.PlayerTank { Name = playerName, Position = new PointF(0, 0) });
                }
            }
        ...
        private static void HandlePlayerPosition(string[] payload)
        {
            ...
            if (playerToUpdate != null)
            {
                ...
                playerToUpdate.DirectionTank = (General.Direction)(Direction)Enum.Parse(typeof(Direction), direction);
